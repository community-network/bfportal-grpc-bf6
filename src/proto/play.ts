...
export const PlayElementDesign: MessageFns<PlayElementDesign> = {
  encode(message: PlayElementDesign, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.blazeSettings !== undefined) {
      BlazePlayElementDesignSettings.encode(message.blazeSettings, writer.uint32(106).fork()).join();
    }
    if (message.modLevelDataId !== undefined) {
      StringValue.encode(message.modLevelDataId, writer.uint32(114).fork()).join();
    }
    for (const v of message.attachments) {
      Attachment.encode(v!, writer.uint32(122).fork()).join();
    }
    for (const v of message.groupLicenses) {
      writer.uint32(130).string(v!);
    }
    if (message.attachmentCompileStatus !== 0) {
      writer.uint32(136).int32(message.attachmentCompileStatus);
    }
...
export const WebPlayDefinition = {
  ...
  methods: {
    createPlayElement: {
      ...
      requestType: CreatePlayElementRequest as typeof CreatePlayElementRequest,
      requestStream: false,
      responseType: PlayElementResponse as typeof PlayElementResponse,
      responseStream: false,
      options: {},
    },
    getPlayElement: {
      name: "getPlayElement",
      requestType: GetPlayElementRequest as typeof GetPlayElementRequest,
      requestStream: false,
      responseType: PlayElementResponse as typeof PlayElementResponse,
      responseStream: false,
      options: {},
    ...
    updatePlayElement: {
      ...
      requestType: UpdatePlayElementRequest as typeof UpdatePlayElementRequest,
      requestStream: false,
      responseType: PlayElementResponse as typeof PlayElementResponse,
      responseStream: false,
      options: {},
    ...
    deletePlayElement: {
      ...
      requestType: DeletePlayElementRequest as typeof DeletePlayElementRequest,
      requestStream: false,
      responseType: DeletePlayElementResponse as typeof DeletePlayElementResponse,
      responseStream: false,
      options: {},
    },
    getOwnedPlayElements: {
      name: "getOwnedPlayElements",
      requestType: GetOwnedPlayElementsRequest as typeof GetOwnedPlayElementsRequest,
      requestStream: false,
      responseType: GetOwnedPlayElementsResponse as typeof GetOwnedPlayElementsResponse,
      responseStream: false,
      options: {},
    },
    getOwnedPlayElementsV2: {
      ...
      requestType: GetOwnedPlayElementsRequest as typeof GetOwnedPlayElementsRequest,
      requestStream: false,
      responseType: GetOwnedPlayElementsResponseV2 as typeof GetOwnedPlayElementsResponseV2,
      responseStream: false,
      options: {},
    },
    getBlueprintsById: {
      name: "getBlueprintsById",
      requestType: GetBlueprintsByIdRequest as typeof GetBlueprintsByIdRequest,
      requestStream: false,
      responseType: GetBlueprintsByIdResponse as typeof GetBlueprintsByIdResponse,
      responseStream: false,
      options: {},
    },
    getScheduledBlueprints: {
      name: "getScheduledBlueprints",
      requestType: GetScheduledBlueprintsRequest as typeof GetScheduledBlueprintsRequest,
      requestStream: false,
      responseType: GetScheduledBlueprintsResponse as typeof GetScheduledBlueprintsResponse,
      responseStream: false,
      options: {},
    },
    createModDataVersion: {
      name: "createModDataVersion",
      requestType: CreateModDataVersionRequest as typeof CreateModDataVersionRequest,
      requestStream: false,
      responseType: CreateModDataVersionResponse as typeof CreateModDataVersionResponse,
      responseStream: false,
      options: {},
    },
    listModDataVersions: {
      name: "listModDataVersions",
      requestType: ListModDataVersionsRequest as typeof ListModDataVersionsRequest,
      requestStream: false,
      responseType: ListModDataVersionsResponse as typeof ListModDataVersionsResponse,
      responseStream: false,
      options: {},
    },
    uploadExperienceThumbnail: {
      name: "UploadExperienceThumbnail",
      requestType: UploadExperienceThumbnailRequest as typeof UploadExperienceThumbnailRequest,
      requestStream: false,
      responseType: UploadExperienceThumbnailResponse as typeof UploadExperienceThumbnailResponse,
      responseStream: false,
      options: {},
    },
    getProgressionTypes: {
      name: "GetProgressionTypes",
      requestType: GetProgressionTypesRequest as typeof GetProgressionTypesRequest,
      requestStream: false,
      responseType: GetProgressionTypesResponse as typeof GetProgressionTypesResponse,
      responseStream: false,
      options: {},
    },
    getLicenseRequirements: {
      name: "GetLicenseRequirements",
      requestType: GetLicenseRequirementsRequest as typeof GetLicenseRequirementsRequest,
      requestStream: false,
      responseType: GetLicenseRequirementsResponse as typeof GetLicenseRequirementsResponse,
      responseStream: false,
      options: {},
    },
    getAvailableTags: {
      name: "GetAvailableTags",
      requestType: GetAvailableTagsRequest as typeof GetAvailableTagsRequest,
      requestStream: false,
      responseType: GetAvailableTagsResponse as typeof GetAvailableTagsResponse,
      responseStream: false,
      options: {},
    },
    listExperiences: {
      name: "ListExperiences",
      requestType: ListExperiencesRequest as typeof ListExperiencesRequest,
      requestStream: false,
      responseType: ListExperiencesResponse as typeof ListExperiencesResponse,
      responseStream: false,
      options: {},
    },
    deleteAttachments: {
      name: "DeleteAttachments",
      requestType: DeleteAttachmentsRequest as typeof DeleteAttachmentsRequest,
      requestStream: false,
      responseType: DeleteAttachmentsResponse as typeof DeleteAttachmentsResponse,
      responseStream: false,
      options: {},
    },
  },
