...
goog.exportSymbol('proto.santiago.web.play.AssetInfo', null, global);
...
goog.exportSymbol('proto.santiago.web.play.EntityList', null, global);
...
goog.exportSymbol('proto.santiago.web.play.Prefab', null, global);
goog.exportSymbol('proto.santiago.web.play.ProcessingStatus', null, global);
goog.exportSymbol('proto.santiago.web.play.ProgressionEntry', null, global);
...
proto.santiago.web.play.GetProgressionTypesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.santiago.web.play.GetProgressionTypesResponse.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.santiago.web.play.ProgressionEntry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.santiago.web.play.ProgressionEntry.repeatedFields_, null);
};
goog.inherits(proto.santiago.web.play.ProgressionEntry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.santiago.web.play.ProgressionEntry.displayName = 'proto.santiago.web.play.ProgressionEntry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.santiago.web.play.AssetInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.santiago.web.play.AssetInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.santiago.web.play.AssetInfo.displayName = 'proto.santiago.web.play.AssetInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.santiago.web.play.Prefab = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.santiago.web.play.Prefab, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.santiago.web.play.Prefab.displayName = 'proto.santiago.web.play.Prefab';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.santiago.web.play.EntityList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.santiago.web.play.EntityList.repeatedFields_, null);
};
goog.inherits(proto.santiago.web.play.EntityList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.santiago.web.play.EntityList.displayName = 'proto.santiago.web.play.EntityList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.santiago.web.play.GetProgressionTypesResponse.repeatedFields_ = [1];
...
proto.santiago.web.play.GetProgressionTypesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.santiago.web.play.ProgressionEntry.toObject, includeInstance)
  };
...
proto.santiago.web.play.GetProgressionTypesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.santiago.web.play.ProgressionEntry;
      reader.readMessage(value,proto.santiago.web.play.ProgressionEntry.deserializeBinaryFromReader);
...
proto.santiago.web.play.GetProgressionTypesResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.santiago.web.play.ProgressionEntry.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.santiago.web.play.ProgressionEntry>}
 */
proto.santiago.web.play.GetProgressionTypesResponse.prototype.getEntriesList = function() {
  return /** @type{!Array<!proto.santiago.web.play.ProgressionEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.santiago.web.play.ProgressionEntry, 1));
};


/**
 * @param {!Array<!proto.santiago.web.play.ProgressionEntry>} value
 * @return {!proto.santiago.web.play.GetProgressionTypesResponse} returns this
*/
proto.santiago.web.play.GetProgressionTypesResponse.prototype.setEntriesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.santiago.web.play.ProgressionEntry=} opt_value
 * @param {number=} opt_index
 * @return {!proto.santiago.web.play.ProgressionEntry}
 */
proto.santiago.web.play.GetProgressionTypesResponse.prototype.addEntries = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.santiago.web.play.ProgressionEntry, opt_index);
};
 ...
 * @return {!proto.santiago.web.play.GetProgressionTypesResponse} returns this
 */
proto.santiago.web.play.GetProgressionTypesResponse.prototype.clearEntriesList = function() {
 ...
 * @const
 */
proto.santiago.web.play.ProgressionEntry.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.santiago.web.play.ProgressionEntry.prototype.toObject = function(opt_includeInstance) {
  return proto.santiago.web.play.ProgressionEntry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.santiago.web.play.ProgressionEntry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.ProgressionEntry.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.santiago.web.play.ProgressionEntry}
 */
proto.santiago.web.play.ProgressionEntry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.santiago.web.play.ProgressionEntry;
  return proto.santiago.web.play.ProgressionEntry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.santiago.web.play.ProgressionEntry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.santiago.web.play.ProgressionEntry}
 */
proto.santiago.web.play.ProgressionEntry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.santiago.web.play.ProgressionEntry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.santiago.web.play.ProgressionEntry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.santiago.web.play.ProgressionEntry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.ProgressionEntry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.santiago.web.play.ProgressionEntry.prototype.getProgressionmode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.santiago.web.play.ProgressionEntry} returns this
 */
proto.santiago.web.play.ProgressionEntry.prototype.setProgressionmode = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.santiago.web.play.ProgressionEntry.prototype.getProgressiblesList = function() {
  return /** @type{!Array<!proto.santiago.web.play.Mutator>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.santiago.web.play.Mutator, 2));
};
 ...
 * @return {!proto.santiago.web.play.ProgressionEntry} returns this
*/
proto.santiago.web.play.ProgressionEntry.prototype.setProgressiblesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 */
proto.santiago.web.play.ProgressionEntry.prototype.addProgressibles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.santiago.web.play.Mutator, opt_index);
};
 ...
 * @return {!proto.santiago.web.play.ProgressionEntry} returns this
 */
proto.santiago.web.play.ProgressionEntry.prototype.clearProgressiblesList = function() {
...
proto.santiago.web.play.AvailableGameData.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    spatialassetinfo: (f = msg.getSpatialassetinfo()) && proto.santiago.web.play.AssetInfo.toObject(includeInstance, f)
  };
...
proto.santiago.web.play.AvailableGameData.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.santiago.web.play.AssetInfo;
      reader.readMessage(value,proto.santiago.web.play.AssetInfo.deserializeBinaryFromReader);
      msg.setSpatialassetinfo(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.santiago.web.play.AvailableGameData.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSpatialassetinfo();
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.santiago.web.play.AssetInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional AssetInfo spatialAssetInfo = 5;
 * @return {?proto.santiago.web.play.AssetInfo}
 */
proto.santiago.web.play.AvailableGameData.prototype.getSpatialassetinfo = function() {
  return /** @type{?proto.santiago.web.play.AssetInfo} */ (
    jspb.Message.getWrapperField(this, proto.santiago.web.play.AssetInfo, 5));
};


/**
 * @param {?proto.santiago.web.play.AssetInfo|undefined} value
 * @return {!proto.santiago.web.play.AvailableGameData} returns this
*/
proto.santiago.web.play.AvailableGameData.prototype.setSpatialassetinfo = function(value) {
  return jspb.Message.setWrapperField(this, 5, value);
};
 ...
 * @return {!proto.santiago.web.play.AvailableGameData} returns this
 */
proto.santiago.web.play.AvailableGameData.prototype.clearSpatialassetinfo = function() {
  return this.setSpatialassetinfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.santiago.web.play.AvailableGameData.prototype.hasSpatialassetinfo = function() {
  return jspb.Message.getField(this, 5) != null;
};
 ...
 * @return {!Object}
 */
proto.santiago.web.play.AssetInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.santiago.web.play.AssetInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.santiago.web.play.AssetInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.AssetInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.santiago.web.play.AssetInfo}
 */
proto.santiago.web.play.AssetInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.santiago.web.play.AssetInfo;
  return proto.santiago.web.play.AssetInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.santiago.web.play.AssetInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.santiago.web.play.AssetInfo}
 */
proto.santiago.web.play.AssetInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.santiago.web.play.AssetInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.santiago.web.play.AssetInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.santiago.web.play.AssetInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.AssetInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.santiago.web.play.Prefab.prototype.toObject = function(opt_includeInstance) {
  return proto.santiago.web.play.Prefab.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.santiago.web.play.Prefab} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.Prefab.toObject = function(includeInstance, msg) {
  var f, obj = {
    prefabinstance: jspb.Message.getFieldWithDefault(msg, 1, ""),
    prefabpartition: jspb.Message.getFieldWithDefault(msg, 2, ""),
    prefabtype: jspb.Message.getFieldWithDefault(msg, 3, ""),
    geminstance: jspb.Message.getFieldWithDefault(msg, 4, ""),
    gempartition: jspb.Message.getFieldWithDefault(msg, 5, ""),
    gemtype: jspb.Message.getFieldWithDefault(msg, 6, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.santiago.web.play.Prefab}
 */
proto.santiago.web.play.Prefab.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.santiago.web.play.Prefab;
  return proto.santiago.web.play.Prefab.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.santiago.web.play.Prefab} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.santiago.web.play.Prefab}
 */
proto.santiago.web.play.Prefab.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setPrefabinstance(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
      msg.setPrefabpartition(value);
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setPrefabtype(value);
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
      msg.setGeminstance(value);
      break;
    case 5:
      var value = /** @type {string} */ (reader.readString());
      msg.setGempartition(value);
      break;
    case 6:
      var value = /** @type {string} */ (reader.readString());
      msg.setGemtype(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.santiago.web.play.Prefab.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.santiago.web.play.Prefab.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.santiago.web.play.Prefab} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.Prefab.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPrefabinstance();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string prefabInstance = 1;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getPrefabinstance = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setPrefabinstance = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string prefabPartition = 2;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getPrefabpartition = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setPrefabpartition = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string prefabType = 3;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getPrefabtype = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setPrefabtype = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional string gemInstance = 4;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getGeminstance = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setGeminstance = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional string gemPartition = 5;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getGempartition = function() {
 ...
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setGempartition = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};


/**
 * optional string gemType = 6;
 * @return {string}
 */
proto.santiago.web.play.Prefab.prototype.getGemtype = function() {
 ...
 * @return {!proto.santiago.web.play.Prefab} returns this
 */
proto.santiago.web.play.Prefab.prototype.setGemtype = function(value) {
 ...
 * @const
 */
proto.santiago.web.play.EntityList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.santiago.web.play.EntityList.prototype.toObject = function(opt_includeInstance) {
  return proto.santiago.web.play.EntityList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.santiago.web.play.EntityList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.EntityList.toObject = function(includeInstance, msg) {
  var f, obj = {
    entityList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.santiago.web.play.EntityList}
 */
proto.santiago.web.play.EntityList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.santiago.web.play.EntityList;
  return proto.santiago.web.play.EntityList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.santiago.web.play.EntityList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.santiago.web.play.EntityList}
 */
proto.santiago.web.play.EntityList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.santiago.web.play.EntityList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.santiago.web.play.EntityList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.santiago.web.play.EntityList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.santiago.web.play.EntityList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.santiago.web.play.EntityList.prototype.getEntityList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.santiago.web.play.EntityList} returns this
 */
proto.santiago.web.play.EntityList.prototype.setEntityList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.santiago.web.play.EntityList} returns this
 */
proto.santiago.web.play.EntityList.prototype.addEntity = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.santiago.web.play.EntityList} returns this
 */
proto.santiago.web.play.EntityList.prototype.clearEntityList = function() {
