...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in localization_pb2_grpc.py depends on'
...
class ClientLocalizationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ClientLocalizationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'santiago.web.localization.ClientLocalization', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('santiago.web.localization.ClientLocalization', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class ClientLocalization(object):
    """Missing associated documentation comment in .proto file."""
